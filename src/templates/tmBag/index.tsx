...
import { SucessfullView } from '@/components/susccessfullView'
...
export const TmBag = () => {
  ...
  const { products, checkout, totalPayment, delivery, successfullView } =
            ...
            {products?.length > 0 ? (
              <>
                {checkout ? (
                  ...
                  <>
                    {products?.map(
                      (product: CardProductsProps, index: number) => (
                        <div
